...
const PartnerForgotPassword = ({ onNavigate }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!err) {
      console.log("Senior Developer: Partner reset link sent to", email);
      onNavigate("PARTNER_VERIFICATION");
    }
  };

  return (
    <div className="partner-forgot-password-view">
      <div className="text-center mb-4">
        <h2 className="text-30-500 text-white">Forgot Password</h2>
