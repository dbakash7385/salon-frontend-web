...
const PartnerResetPassword = ({ onNavigate }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      console.log("Senior Developer: Partner Password reset successful", formData);
  ...
  return (
    <div className="partner-reset-password-view">
      <div className="text-center mb-4">
        <h2 className="text-30-500 text-white">Reset Password</h2>
        <p className="text-16-400-inter mb-3">Set new password</p>
